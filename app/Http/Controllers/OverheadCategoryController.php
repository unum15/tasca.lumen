...
class OverheadCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $items_query = OverheadCategory::whereNull('parent_id')->with('children')->with('children.children')->with('children.children.children')->with('children.children.children.children');
