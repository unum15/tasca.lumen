...
class PropertyTypeControllerTest extends TestCase
{
    ...
    public function testIndex()
    {
        ...
        $response0 = $this->post('/property_type',$items[0]);
        $response0->seeStatusCode(200);                
        $response1 = $this->post('/property_type',$items[1]);
    ...
    public function testCreate()
    {
        ...
        $response = $this->post('/property_type',$item);
        $response->seeStatusCode(200);                
    ...
    public function testRead()
    {
        ...
        $response->seeStatusCode(200);
        $response_array = json_decode($response->response->getContent());
        $response = $this->get('/property_type/' . $response_array->id);
        $response->seeStatusCode(200);
        $response->seeJson($item);        
        $dbitem = PropertyType::find($response_array->id);
        $response->seeJsonEquals($dbitem->toArray());
    ...
    {        
        $response = $this->get('/property_type/a');
    ...
    public function testCreateDoubleDefault()
    {
        ...
        $response = $this->post('/property_type',$items[0]);
        $response->seeStatusCode(200);
        $response_array = json_decode($response->response->getContent());        
        $response = $this->post('/property_type',$items[1]);
        $response->seeStatusCode(200);                
        $dbitem = PropertyType::find($response_array->id);
    ...
    public function testUpdate()
    {
        ...
        $response_array = json_decode($response->response->getContent());
        $patch = ['name' => 'Test 2'];
        $response = $this->patch('/property_type/' . $response_array->id, $patch);
        $response->seeStatusCode(200);
    ...
    public function testDelete()
    {
        ...
        $response->seeStatusCode(200);
        $response_array = json_decode($response->response->getContent());
        $response = $this->delete('/property_type/' . $response_array->id);
